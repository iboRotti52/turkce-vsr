...
# YEREL DEGISIKLIK (bkz. README.md "Yapilan degisiklik"):
# `from skimage import transform as tf` KALDIRILDI. skimage yalnizca asagidaki
# warp_img/apply_transform fonksiyonlarinda kullaniliyordu; o fonksiyonlar bu
# dosyada hicbir yerden CAGRILMIYOR (VideoProcess cv2.warpAffine kullaniyor).
# Kullanilmayan agir bir bagimliligi (scikit-image + scipy) kurmamak icin
# fonksiyonlar da birlikte silindi. Baska hicbir sey degistirilmedi.
